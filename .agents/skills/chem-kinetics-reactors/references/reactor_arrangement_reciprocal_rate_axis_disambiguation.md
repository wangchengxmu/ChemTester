...
Use when selecting or comparing an arrangement of ideal reactor units from rate plots, especially when candidate methods differ by concentration versus conversion axes or by sizing versus sequencing purpose.
