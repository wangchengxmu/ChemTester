...
Liquid-liquid extraction data at two or more extractant concentrations and acidities must be used to infer a neutral metal complex, write the extraction reaction, calculate its equilibrium constant, or audit numbered statements.
