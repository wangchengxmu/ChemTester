...
A crystal-structure problem gives fractional coordinates or layered symmetry, a distorted-polyhedron angle, and asks for a lattice parameter or local geometry.
