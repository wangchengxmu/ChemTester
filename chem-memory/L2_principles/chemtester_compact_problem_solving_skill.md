...
**Use when:** An educational question asks about initial corrosive skin or eye decontamination; the substance and any product-specific instructions must be...
...
**Use when:** An inorganic reaction or multi-process equation-selection problem requires product identification, balancing, coefficient-derived quantities...
