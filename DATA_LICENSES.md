...
|---|---|---|
| ChemBench | MIT; <https://huggingface.co/datasets/jablonkagroup/ChemBench> | Included in the public preview with source identifiers retained. The upstream canary warns against use in training corpora. |
| QCBench | Apache-2.0; <https://huggingface.co/datasets/jiaxie/QCBench> | Included in the public preview. Underlying textbook/SciBench provenance still requires row-level review before the final archival release. |
...
| SUPERChem | MIT; <https://huggingface.co/datasets/ZehuaZhao/SUPERChem> | Included in the public preview. The upstream canary warns against use in training corpora. |
...
| OlympicArena | CC BY-NC-SA 4.0; <https://huggingface.co/datasets/GAIR/OlympicArena> | Included for noncommercial use. GAIR/OlympicArena attribution, the license notice, and share-alike terms must be preserved. |
...
| ChemTester native vision items | Repository-authored deterministic generator and locally sealed assets | Included as project-authored evaluation data. |

## Attribution requirements

Any redistribution must retain each record's source repository and source
question identifier, include the citations requested by the upstream dataset
cards, and preserve all applicable copyright and license notices. The public
preview is not a representation that every underlying source right has been
